...
$acc_username = "JuneCharlesMariquit";
$acc_password = "JuneCharlesMariquit";
$acc_fullname = "June Charles Mariquit";
$acc_address = "Nangka II Mogpog Marinduque";
...
if(isset($_REQUEST['login_button']) === true){
	//get the username and passrod from the form and compare to the predefined username and password
		//kapag malo agad yung username
		if($_REQUEST['form_username'] != $acc_username){
				header("Location: ".$url_add."?notexist");
		}
		//tama amd userame peru mali ang password
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      					...
		      					echo "<div class='alert alert-danger' role='alert'>User name does not exist...</div>";
		      				...
		      				echo "<div class='alert alert-warning' role='alert'>You are still login, <a href='account.php'> Please click here </a>to proceed. </div>";
		      			}
